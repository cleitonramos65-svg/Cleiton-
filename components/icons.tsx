...
export const FuelIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16V5.5a2.5 2.5 0 012.5-2.5h0A2.5 2.5 0 0113 5.5V16m-5 0h5m-5 0a2.5 2.5 0 100 5h5a2.5 2.5 0 100-5M5 16h14" />
  </svg>
);

export const RoadIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V4a1 1 0 00-1-1H4a1 1 0 00-1 1v12a1 1 0 001 1h8a1 1 0 001-1zm-5-4h2m-2-4h2" />
...
export const CarIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17l-2 2m0 0l-2-2m2 2v-4.586a1 1 0 01.293-.707l3.414-3.414a1 1 0 01.707-.293h4.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V17m-4.5-5.5a.5.5 0 11-1 0 .5.5 0 011 0zM19 17l-2 2m0 0l-2-2m2 2v-4.586a1 1 0 00-.293-.707l-3.414-3.414a1 1 0 00-.707-.293h-4.586a1 1 0 00-.707.293l-3.414 3.414A1 1 0 005 12.414V17" />
    </svg>
);
